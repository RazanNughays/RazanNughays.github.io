...
<p style="text-align: left; font-size: 0.9em; color: gray;">
  Ultrafast Scanning Electron Microscopy (4D-USEM) setup for imaging carrier dynamics in real space and real time. A femtosecond laser is integrated into the SEM, enabling simultaneous high spatial resolution and ultrafast temporal resolution (~10<sup>-15</sup> s).
</p>
